...
<br>
    <form method="POST" action="" class="header-margin-top" enctype="multipart/form-data">
        ...
        <h2 class="comment-title">グループ名</h2>
        <div>
            <input class="text-box" type="text" style="margin-top: 30px;" name="group_name" placeholder="グループ名（最大30文字）" maxlength="30" required>
        </div>
        <h2 class="comment-title">パスワード</h2>
        <div>
            <input class="text-box" type="password" style="margin-top: 30px;" name="group_pass" placeholder="パスワード（最大32文字）" maxlength="30" required>
        </div>
        <h2 class="comment-title">パスワード再入力</h2>
        <div>
            <input class="text-box" type="password" style="margin-top: 30px;" name="group_repass" placeholder="パスワード再入力" maxlength="30" required>
        </div>
        ...
        <button class="btn-create btn-style" style="margin-top: 252px;" name="groupcreate">作成</button>
    </form>
