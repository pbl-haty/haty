...
<body>
    ...
    <div class="gift_detail">
        ...
        <div class="btn_center"><button type="submit" class="gift_complete" name="gift_complete">取引完了にする</button></div><br>
        <div class="btn_right"><button type="submit" class="look_gift" name="look_gift">投稿画面を見る</button></div>
        <ul class="slider">
        ...
        <form method="POST" action="example.cgi" onSubmit="return delete_check()">
        <div class="btn_center"><button type="submit" class="gift_delete" name="gift_delete">投稿削除</button></div>
            </form>
    </div>
    ...
    <script type="text/javascript">
        ...
        function delete_check() {
            ...
            if (window.confirm('投稿を削除します\n本当によろしいですか？')) { // 確認ダイアログを表示
                ...
                window.alert('削除ががキャンセルされました'); // 警告ダイアログを表示
                return false; // 送信を中止
